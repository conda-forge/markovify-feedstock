...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/markovify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4721&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/markovify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `markovify` can be installed with:

```
conda install markovify
```

It is possible to list all of the versions of `markovify` available on your platform with:
